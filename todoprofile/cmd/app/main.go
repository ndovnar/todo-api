...
import (
	...
	"todoprofile/db"
	"todoprofile/internal/config"
	"todoprofile/internal/httpapi"
	"todoprofile/internal/repository/mongo"
...
func main() {
	...
	profileRepository := mongo.NewProfileRepository(mongodb.DB)
	profileService := service.NewProfileService(profileRepository)

	httpapi := httpapi.New(&config.HTTPAPI, publicKey, profileService)
